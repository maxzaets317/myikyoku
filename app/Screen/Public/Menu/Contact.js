        ...
        return <Container style={Style.bgMain}>
            <Header style={Style.navigation}>
                ...
                <Body style={Style.positionCenter}>
                    <Text style={Style.headerTitle}>お問い合わせ</Text>
                </Body>
            ...
            <MyWebView onLoad={() => this.setState({ isLoadingWebView: false })} automaticallyAdjustContentInsets={true} source={{ uri: 'https://www.doctor-agent.com/inquiry' }} />
            {
