...
import {ActivityIndicator, Image, WebView} from 'react-native'
        ...
        return <Container style={Style.bgMain}>
            <Header style={Style.navigation}>
                ...
                <Body style={Style.positionCenter}>
                    <Text style={Style.headerTitle}>ユーザー情報編集</Text>
                </Body>
            ...
            <MyWebView onLoad={() => this.setState({ isLoadingWebView: false })} automaticallyAdjustContentInsets={true} source={{ uri: 'https://www.doctor-agent.com/mypage/profile-setting/member-update' }} />
            {
