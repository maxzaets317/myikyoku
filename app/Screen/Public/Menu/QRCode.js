        ...
        return <Container style={Style.bgMain}>
            <Header style={Style.navigation}>
                ...
                <Body style={Style.positionCenter}>
                    <Text style={Style.headerTitle}>QR Code</Text>
                </Body>
            ...
            <MyWebView onLoad={() => this.setState({ isLoadingWebView: false })} automaticallyAdjustContentInsets={true} source={{ uri: 'https://www.residentnavi.com/mypage/qr' }} />
                {
